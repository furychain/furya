...
// source: furya/irc/irc_requests.proto
...
type IRCRequest struct {
	...
	MessageType MsgType `protobuf:"varint,3,opt,name=message_type,json=messageType,proto3,enum=xblackfury.furya.irc.MsgType" json:"message_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("xblackfury.furya.irc.MsgType", MsgType_name, MsgType_value)
	proto.RegisterType((*IRCRequest)(nil), "xblackfury.furya.irc.IRCRequest")
}
