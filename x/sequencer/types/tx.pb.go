...
// source: furya/sequencer/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateSequencer)(nil), "furyaxyz.furya.sequencer.MsgCreateSequencer")
	proto.RegisterType((*MsgCreateSequencerResponse)(nil), "furyaxyz.furya.sequencer.MsgCreateSequencerResponse")
}
...
func (c *msgClient) CreateSequencer(ctx context.Context, in *MsgCreateSequencer, opts ...grpc.CallOption) (*MsgCreateSequencerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaxyz.furya.sequencer.Msg/CreateSequencer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateSequencer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaxyz.furya.sequencer.Msg/CreateSequencer",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaxyz.furya.sequencer.Msg",
	...
	Metadata: "furya/sequencer/tx.proto",
}
