...
// source: furya/sequencer/scheduler.proto
...
func init() {
	proto.RegisterType((*Scheduler)(nil), "furyaxyz.furya.sequencer.Scheduler")
}

func init() {
	proto.RegisterFile("furya/sequencer/scheduler.proto", fileDescriptor_68e4ce79da53e96a)
}
