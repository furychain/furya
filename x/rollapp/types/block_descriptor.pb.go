...
// source: furya/rollapp/block_descriptor.proto
...
func init() {
	proto.RegisterType((*BlockDescriptor)(nil), "furyaxyz.furya.rollapp.BlockDescriptor")
	proto.RegisterType((*BlockDescriptors)(nil), "furyaxyz.furya.rollapp.BlockDescriptors")
}

func init() {
	proto.RegisterFile("furya/rollapp/block_descriptor.proto", fileDescriptor_9e537259fa860c20)
}
