...
// source: furya/rollapp/state_status.proto
...
func init() {
	proto.RegisterEnum("xblackfury.furya.rollapp.StateStatus", StateStatus_name, StateStatus_value)
}

func init() {
	proto.RegisterFile("furya/rollapp/state_status.proto", fileDescriptor_b039e93a8767dffd)
}
