...
// source: furya/rollapp/state_info.proto
...
type StateInfo struct {
	...
	Status StateStatus `protobuf:"varint,8,opt,name=status,proto3,enum=xblackfury.furya.rollapp.StateStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterType((*StateInfoIndex)(nil), "xblackfury.furya.rollapp.StateInfoIndex")
	proto.RegisterType((*StateInfo)(nil), "xblackfury.furya.rollapp.StateInfo")
	proto.RegisterType((*BlockHeightToFinalizationQueue)(nil), "xblackfury.furya.rollapp.BlockHeightToFinalizationQueue")
}

func init() {
	proto.RegisterFile("furya/rollapp/state_info.proto", fileDescriptor_17fce0215a9cbbfb)
}
